    ...
    public static File getOutputMediaFile(int type) {
        ...
        if (!mediaStorageDir.exists()) {
            if (!mediaStorageDir.mkdirs()) {
                Log.e(ViewInspectionReportScreen.GALLERY_DIRECTORY_NAME, "Oops! Failed create "
                        + ViewInspectionReportScreen.GALLERY_DIRECTORY_NAME + " directory");
                return null;
            }
        }
        ...
        File mediaFile;
        if (type == ViewInspectionReportScreen.MEDIA_TYPE_IMAGE) {
            mediaFile = new File(mediaStorageDir.getPath() + File.separator
                    + "IMG_" + timeStamp + "." + ViewInspectionReportScreen.IMAGE_EXTENSION);
        } else if (type == ViewInspectionReportScreen.MEDIA_TYPE_VIDEO) {
            mediaFile = new File(mediaStorageDir.getPath() + File.separator
                    + "VID_" + timeStamp + "." + ViewInspectionReportScreen.VIDEO_EXTENSION);
        } else {
            return null;
        }
